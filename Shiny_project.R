# Author Name - Ranganath Srinivasan Kalaimani
# Description - This project was submitted for Monash University - FIT5147
# Student ID - 29360714
"****
  ...
  ****"
  output$Sankeyplot <- renderPlot({
    ggplot(sankey_data[sankey_data$Season >= input$year[1] & sankey_data$Season <= input$year[2],],
      ...
      scale_x_discrete(limits = c("Teams", "Drivers","Type"), expand = c(.5, .05))
  })
